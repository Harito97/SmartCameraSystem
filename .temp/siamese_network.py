...
class SiameseNetwork(nn.Module):
    def __init__(self, backbone="resnet18"):
        ...
        if backbone not in models.__dict__:
            raise Exception(
                "No model named {} exists in torchvision.models.".format(backbone)
            )
    ...
    def forward(self, img1, img2):
        ...
        # # Chuyển đổi hình ảnh thành tensor trước khi truyền vào mô hình
        # img1 = transform(img1)  # _tensor
        # img2 = transform(img2)  # _tensor
